...
ggplot(dataframe, aes(x = age, y = mean_length, color = pool)) +
  ...
  labs(title = "Observed vs Fitted Lengths using VBGF",
...
ggplot(dataframe, aes(x = age, y = mean_width, color = pool)) +
  ...
  labs(title = "Observed vs Fitted Widths using VBGF",
       x = "Age (years)", y = "Length (mm)") +
  theme_solarized_2() +
  theme(plot.title = element_text(size = 13))
...
ggplot(dataframe, aes(x = age, y = mean_weight, color = pool)) +
  ...
  labs(title = "Observed vs Fitted Weights using VBGF",
       x = "Age (years)", y = "Length (mm)") +
  theme_solarized_2() +
  theme(plot.title = element_text(size = 13))
...
ggplot() +
  ...
  # Labels and title
  labs(title = "Observed vs Fitted and Future Predicted Lengths using VBGF",
       x = "Age (years)", y = "Length (mm)") +
...
ggplot() +
  ...
  # Labels and title
  labs(title = "Observed vs Fitted and Future Predicted Widths using VBGF",
       x = "Age (years)", y = "Length (mm)") +
...
ggplot() +
  ...
  # Labels and title
  labs(title = "Observed vs Fitted and Future Predicted Weights using VBGF",
       x = "Age (years)", y = "Length (mm)") +
